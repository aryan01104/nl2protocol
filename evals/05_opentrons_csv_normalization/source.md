# Source — Opentrons Protocols 5654c0 "DNA Normalization from .csv"

**URL:** https://github.com/Opentrons/Protocols/tree/develop/protocols/5654c0
**Pulled:** 2026-05-29
**Categories:** Sample Prep > Normalization
**License:** Opentrons-published, public

This is an Opentrons-templated README (over-structured vs. a real lab note) but the CSV format and protocol steps are real, and CSV-driven normalization is one of the most-requested OT-2 use cases. Per "originals as found" — using verbatim.
