# Source — Lotterhos Lab Magnetic Bead Wash

**URL:** https://drk-lo.github.io/lotterhoslabprotocols/molecprot_magbeadwash.html
**Lab:** Lotterhos Lab (marine genomics, Northeastern University)
**Pulled:** 2026-05-29
**License:** site is publicly published; protocol is derivative of Kapa Pure Beads user guide

Full document below, verbatim from the source page. The actual eval instruction (`instruction.txt`) uses Section 2 only — see that file for which slice was chosen and why.
...
3.11 Place the plate/tube(s) on a magnet to capture the beads. Incubate until the liquid is clear. Carefully remove and discard the supernatant which contains library molecules smaller than 250 bp.
...
3.14 Carefully remove and discard the ethanol.

3.15 Keeping the plate/tube(s) on the magnet, add 200 μL of 80% ethanol.
...
3.18 Dry the beads at room temperature for 3 – 5 min, or until all of the ethanol has evaporated. Caution: over-drying the beads may result in reduced yield.
