...
metadata = {'protocolName': 'spri_bead_cleanup', 'author': 'Biolab AI', 'apiLevel': '2.15'}
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    pip_left.mix(10, 100.0, lw_4['A1'])
    pip_left.drop_tip()
    protocol.delay(minutes=5.0)
    mod_4.engage()
    protocol.pause('Wait until the liquid is clear before proceeding to supernatant removal.')
    pip_left.transfer(180.0, lw_4['A1'], lw_4['A1'])
    pip_left.transfer(200.0, lw_3['A1'], lw_4['A1'])
    protocol.delay(seconds=30.0)
    pip_left.transfer(200.0, lw_4['A1'], lw_4['A1'])
    pip_left.transfer(200.0, lw_3['A1'], lw_4['A1'])
    protocol.delay(seconds=30.0)
    pip_left.transfer(200.0, lw_4['A1'], lw_4['A1'])
    ...
    mod_4.engage()
    protocol.pause('Wait until the liquid is clear before collecting the final eluate.')
    pip_left.transfer(30.0, lw_4['A1'], lw_5['A1'])